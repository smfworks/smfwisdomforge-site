...
const audioClips = [
  { ch: 1, title: "The Hazelnut" },
  { ch: 2, title: "All Shall Be Well" },
  { ch: 3, title: "The Motherhood of God" },
  { ch: 4, title: "Sin as Behovely" },
  { ch: 5, title: "The Trinity as Loving Community" },
  { ch: 6, title: "The Body as Revelation" },
];
              ...
              >
                ...
                <div className="relative z-10 flex flex-col sm:flex-row gap-6">
                  <div className="relative w-full sm:w-40 aspect-[3/4] rounded-xl overflow-hidden border border-[#2a2a35] flex-shrink-0">
                    <Image
                      src={`/images/booklets/julian-norwich-${group.slug}-cover.png`}
                      alt={`Julian of Norwich ${group.title} — ${group.ages}`}
                      fill
                      className="object-cover"
                    />
                  </div>
                  <div className="flex-1 flex flex-col">
                    ...
                    <a
                      href={`/downloads/julian-norwich-${group.slug}.pdf`}
                      download
      ...
      <section id="audio" className="py-24 md:py-32 px-6 bg-[#0f0f14] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#F5F0E8] mb-4">
              Listen to <span className="text-[#7BA3A8]">Julian</span>
            </h2>
            <p className="text-[#6B6560] text-lg max-w-2xl mx-auto">
                ...
                <div className="space-y-3">
                  {audioClips.map((clip) => (
                    <div key={`${age}-${clip.ch}`} className="flex items-center gap-3 text-sm">
                      ...
                      <a
                        href={`/audio/julian-norwich/julian-norwich-${age}-ch0${clip.ch}.mp3`}
      ...
      <section className="py-24 md:py-32 px-6 bg-[#0a0a0f] relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-[#A89B8C] mb-8">
            Get the complete Julian of Norwich series for every age group. No email required.
          </p>
          <Link
            href="#booklets"
