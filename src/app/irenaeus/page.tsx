...
const audioClips = [
  { ch: 1, title: "The Rule of Faith" },
  { ch: 2, title: "Recapitulation" },
  { ch: 3, title: "Creation Is Good" },
  { ch: 4, title: "The Full Humanity of Christ" },
  { ch: 5, title: "Apostolic Tradition" },
  { ch: 6, title: "The Unity of Scripture" },
];
      ...
      <section id="audio" className="py-24 md:py-32 px-6 bg-[#0f0f14] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#F5F0E8] mb-4">
              Listen to <span className="text-[#7BA3A8]">Irenaeus</span>
            </h2>
            <p className="text-[#6B6560] text-lg max-w-2xl mx-auto">
                ...
                <div className="space-y-3">
                  {audioClips.map((clip) => (
                    <div key={`${age}-${clip.ch}`} className="flex items-center gap-3 text-sm">
                      ...
                      <a
                        href={`/audio/irenaeus/irenaeus-${age}-ch0${clip.ch}.mp3`}
