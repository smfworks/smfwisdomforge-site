...
const audioClips = [
  { ch: 1, title: "The Traveler from Samos" },
  { ch: 2, title: "All Is Number" },
  { ch: 3, title: "The Harmony of the Spheres" },
  { ch: 4, title: "The Soul's Journey" },
  { ch: 5, title: "The Tetractys" },
  { ch: 6, title: "Tuning Your Life" },
];
      ...
      <section id="audio" className="py-24 md:py-32 px-6 bg-[#0f0f14] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#F5F0E8] mb-4">
              Listen to <span className="text-[#7BA3A8]">Pythagoras</span>
            </h2>
            <p className="text-[#6B6560] text-lg max-w-2xl mx-auto">
                ...
                <div className="space-y-3">
                  {audioClips.map((clip) => (
                    <div key={`${age}-${clip.ch}`} className="flex items-center gap-3 text-sm">
                      ...
                      <a
                        href={`/audio/pythagoras/pythagoras-${age}-ch0${clip.ch}.mp3`}
