...
export const metadata: Metadata = {
  title: "Gregory of Nazianzus — WisdomForge by Airia Edge",
  description:
    "Free WisdomForge booklets on Gregory of Nazianzus, theologian and poet, for ages 5 to adult. Download PDFs and explore the Cappadocian father who defended the Trinity, articulated Christology, and retired to write poetry.",
  alternates: { canonical: "https://smfwisdomforge.com/gregory-nazianzus" },
  openGraph: {
    title: "Gregory of Nazianzus — WisdomForge by Airia Edge",
    description:
      "Free WisdomForge booklets on Gregory of Nazianzus, theologian and poet, for ages 5 to adult.",
    url: "https://smfwisdomforge.com/gregory-nazianzus",
    siteName: "WisdomForge",
    images: [{ url: "https://smfwisdomforge.com/images/booklets/gregory-nazianzus-adult-cover.png" }],
    locale: "en_US",
    type: "article",
  },
};
...
const ageGroups = [
  {
    ...
    slug: "elementary",
    description:
      "Gentle stories about a boy who loved books, ran away when they tried to make him a bishop, and became one of the greatest talkers about God the world has ever known. Six chapters with activities about friendship, courage, and the mystery of God becoming human.",
    color: "#C9A96E",
  },
  {
    label: "Young Minds",
    ages: "Ages 11–14",
    title: "The Student and the Friend",
    slug: "middle",
    description:
      "Gregory of Nazianzus for middle-school readers: the student who became a bishop, the reluctant priest, the defender of the Trinity, and the poet who went home. Real-life scenarios, creative projects, and discussion questions about vocation, friendship, and speaking carefully about God.",
    color: "#7BA3A8",
  },
  {
    label: "Emerging Adults",
    ages: "Ages 15–18",
    title: "Education, Friendship, and the Trinity",
    slug: "high",
    description:
      "A rigorous treatment for older teens. Gregory's formation in Athens, the Five Theological Orations, apophaticism as epistemology, the Christological principle, and his retirement as a poet. Scholarly debate paragraphs engage real patristic questions about the Theologian.",
    color: "#B87D6A",
  },
  {
    label: "Lifelong Learners",
    ages: "Adult",
    title: "Theologian, Poet, and the Incomprehensible God",
    slug: "adult",
    description:
      "Gregory as a serious pastoral theologian of the Trinity, apophaticism, Christology, and the cost of vocation. Six chapters engaging his education, the reluctant bishop, the Five Theological Orations, the incomprehensibility of God, the Christological principle, and his poetic legacy.",
    color: "#8A9A7B",
  },
];

const chapterThemes = [
  { n: 1, title: "Education, Friendship, and Formation", theme: "Athenian paideia, the friendship with Basil, and the making of a theologian" },
  { n: 2, title: "The Reluctant Bishop", theme: "Vocation, resistance, integrity, and the cost of obedience" },
  { n: 3, title: "The Five Theological Orations", theme: "The Trinity defended, the Pneumatomachi answered, and the shape of Nicene theology" },
  { n: 4, title: "The Incomprehensibility of God", theme: "Apophaticism as epistemology, the limits of human knowing, and theological humility" },
  { n: 5, title: "Christology — What Is Not Assumed Is Not Healed", theme: "The Incarnation, two natures, and the principle that shaped Chalcedon" },
  { n: 6, title: "The Poet Who Went Home", theme: "Retirement, grief, poetry, and the legacy of a theologian" },
];

const audioClips = [
  { ch: 1, title: "Education, Friendship, and Formation" },
  { ch: 2, title: "The Reluctant Bishop" },
  { ch: 3, title: "The Five Theological Orations" },
  { ch: 4, title: "The Incomprehensibility of God" },
  { ch: 5, title: "Christology — What Is Not Assumed Is Not Healed" },
  { ch: 6, title: "The Poet Who Went Home" },
];

export default function GregoryOfNazianzusPage() {
  return (
    <>
      {/* HERO */}
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#0a0a0f]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-[#A89B8C] mb-4 max-w-2xl mx-auto leading-relaxed font-light">
            The theologian who defended the Trinity, articulated the mystery of Christ, and retired to write poetry in the mountains.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-[1fr_1.5fr] gap-12 items-start">
            <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-[#2a2a35] bg-[#13131a]">
              <Image
                src="/images/booklets/gregory-nazianzus-adult-cover.png"
                alt="Gregory of Nazianzus: Theologian, Poet, and the Incomprehensible God — book cover"
                fill
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#F5F0E8] leading-tight">
                The Theologian who taught the church to speak carefully about God.
              </h2>
              <div className="space-y-4 text-[#A89B8C] text-lg leading-relaxed">
                <p>
                  Gregory of Nazianzus (c. 329–390 CE) was called &ldquo;the Theologian&rdquo; in his own lifetime — a title the Eastern Church still gives him. With Basil of Caesarea and Gregory of Nyssa, he completed the doctrinal vocabulary of Nicaea: one divine essence in three distinct persons. His Five Theological Orations, preached in Constantinople in 380 CE, are the most rhetorically powerful defense of trinitarian theology in the patristic era.
                </p>
                <p>
                  He was also the first theologian to articulate the principle that would shape the Council of Chalcedon: &ldquo;What has not been assumed has not been healed.&rdquo; His Christology — Christ as fully God and fully human — set the terms for every subsequent debate. He was a reluctant bishop, a poet who longed for solitude, and a man who knew the cost of vocation. He retired to his family estate in Cappadocia and spent his final years writing poetry — grief, beauty, and the mystery of a God who exceeds every human word.
                </p>
                <p className="text-[#C9A96E]">
                  WisdomForge adapts Gregory across four age levels so the same core ideas grow with the reader.
                </p>
              </div>
            </div>
          </div>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col sm:flex-row gap-6">
                  <div className="relative w-full sm:w-40 aspect-[3/4] rounded-xl overflow-hidden border border-[#2a2a35] flex-shrink-0">
                    <Image
                      src={`/images/booklets/gregory-nazianzus-${group.slug}-cover.png`}
                      alt={`Gregory of Nazianzus ${group.title} — ${group.ages}`}
                      fill
                      className="object-cover"
                    />
                  </div>
                  <div className="flex-1 flex flex-col">
                    ...
                    <a
                      href={`/downloads/gregory-nazianzus-${group.slug}.pdf`}
                      download
      ...
      <section id="audio" className="py-24 md:py-32 px-6 bg-[#0f0f14] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#F5F0E8] mb-4">
              Listen to <span className="text-[#7BA3A8]">Gregory Nazianzus</span>
            </h2>
            <p className="text-[#6B6560] text-lg max-w-2xl mx-auto">
                ...
                <div className="space-y-3">
                  {audioClips.map((clip) => (
                    <div key={`${age}-${clip.ch}`} className="flex items-center gap-3 text-sm">
                      ...
                      <a
                        href={`/audio/gregory-nazianzus/gregory-nazianzus-${age}-ch0${clip.ch}.mp3`}
      ...
      <section className="py-24 md:py-32 px-6 bg-[#0a0a0f] relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-[#A89B8C] mb-8">
            Get the complete Gregory of Nazianzus series for every age group. No email required.
          </p>
          <Link
            href="#booklets"
