...
export const metadata: Metadata = {
  title: "Athanasius of Alexandria — WisdomForge by Airia Edge",
  description:
    "Free WisdomForge booklets on Athanasius of Alexandria, bishop and theologian, for ages 5 to adult. Download PDFs and explore the defender of Nicaea, the logic of the Incarnation, theosis, and the Holy Spirit.",
  alternates: { canonical: "https://smfwisdomforge.com/athanasius" },
  openGraph: {
    title: "Athanasius of Alexandria — WisdomForge by Airia Edge",
    description:
      "Free WisdomForge booklets on Athanasius of Alexandria, bishop and theologian, for ages 5 to adult.",
    url: "https://smfwisdomforge.com/athanasius",
    siteName: "WisdomForge",
    images: [{ url: "https://smfwisdomforge.com/images/booklets/athanasius-adult-cover.png" }],
    locale: "en_US",
    type: "article",
  },
};
...
const ageGroups = [
  {
    ...
    ages: "Ages 5–10",
    title: "The Bishop Who Said No to Kings",
    slug: "elementary",
    description:
      "A gentle retelling of Athanasius's story: the King who came down, the Son who is one with God, the promise that we are made to shine, and the brave bishop who would not stop teaching the truth. Six chapters with activities and questions for young readers.",
    color: "#C9A96E",
  },
  {
    label: "Young Minds",
    ages: "Ages 11–14",
    title: "Athanasius and the Battle for the Real Jesus",
    slug: "middle",
    description:
      "Athanasius for middle-school readers: the logic of the Incarnation, the meaning of homoousios, deification, creation and fall, the victory of the cross, and the Holy Spirit. Comparison tables, Try This activities, and discussion questions.",
    color: "#7BA3A8",
  },
  {
    label: "Emerging Adults",
    ages: "Ages 15–18",
    title: "Athanasius: Theology on the Run",
    slug: "high",
    description:
      "A rigorous treatment for older teens. Athanasius's argument for the Incarnation, the defense of Nicaea, deification and theosis, creation and fall, Christus Victor, and the person of the Holy Spirit. Real quotations and scholarly-debate paragraphs.",
    color: "#B87D6A",
  },
  {
    label: "Lifelong Learners",
    ages: "Adult",
    title: "Athanasius of Alexandria: The Word Became Flesh",
    slug: "adult",
    description:
      "Athanasius as a serious theologian of creation, fall, Incarnation, deification, cross, and Spirit. Six substantial chapters with primary-source quotations, scholarly debate, and no devotional padding. For readers ready to think with the fourth century.",
    color: "#8A9A7B",
  },
];

const chapterThemes = [
  { n: 1, title: "The Logic of the Incarnation", theme: "Why only God can rescue humanity from death" },
  { n: 2, title: "Homoousios and the Identity of Christ", theme: "The Son is of one substance with the Father" },
  { n: 3, title: "He Was Made Man That We Might Be Made God", theme: "Deification by participation, not by nature" },
  { n: 4, title: "Created for Incorruption", theme: "Creation, fall, and the restoration of life" },
  { n: 5, title: "Christus Victor and the Empty Tomb", theme: "The cross as payment and victory over death" },
  { n: 6, title: "The Holy Spirit and the Completion of the Gospel", theme: "The Spirit makes the Incarnation real in believers" },
];

const audioClips = [
  { ch: 1, title: "The Logic of the Incarnation" },
  { ch: 2, title: "Homoousios and the Identity of Christ" },
  { ch: 3, title: "He Was Made Man That We Might Be Made God" },
  { ch: 4, title: "Created for Incorruption" },
  { ch: 5, title: "Christus Victor and the Empty Tomb" },
  { ch: 6, title: "The Holy Spirit and the Completion of the Gospel" },
];

export default function AthanasiusPage() {
  return (
    <>
      {/* HERO */}
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#0a0a0f]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-[#A89B8C] mb-4 max-w-2xl mx-auto leading-relaxed font-light">
            The young bishop who defended Nicaea, outlasted five exiles, and taught the church that the Word became flesh.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-[1fr_1.5fr] gap-12 items-start">
            <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-[#2a2a35] bg-[#13131a]">
              <Image
                src="/images/booklets/athanasius-adult-cover.png"
                alt="Athanasius of Alexandria: The Word Became Flesh — book cover"
                fill
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#F5F0E8] leading-tight">
                The bishop who would not bend, even when emperors told him to.
              </h2>
              <div className="space-y-4 text-[#A89B8C] text-lg leading-relaxed">
                <p>
                  Athanasius of Alexandria (c. 296–373 CE) became bishop before he was thirty and spent forty-five years holding the see. Seventeen of those years were spent in exile. Five times emperors and rival councils drove him from his city; five times he returned. The reason was simple: he believed that Jesus of Nazareth is the eternal Son of God, of one substance — <em>homoousios</em> — with the Father. If that truth were lost, he argued, the gospel itself would be lost.
                </p>
                <p>
                  His <em>On the Incarnation</em> is one of the most influential works in Christian history. It argues that the Creator became a human being because only the Creator could defeat death. His <em>Orations Against the Arians</em> defended the Council of Nicaea and the word <em>homoousios</em>. His <em>Letters to Serapion</em> extended the same logic to the Holy Spirit. And his reported <em>Life of Antony</em> made Christian monasticism visible to the Roman world.
                </p>
                <p className="text-[#C9A96E]">
                  WisdomForge adapts Athanasius across four age levels so the same core ideas grow with the reader.
                </p>
              </div>
            </div>
          </div>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col sm:flex-row gap-6">
                  <div className="relative w-full sm:w-40 aspect-[3/4] rounded-xl overflow-hidden border border-[#2a2a35] flex-shrink-0">
                    <Image
                      src={`/images/booklets/athanasius-${group.slug}-cover.png`}
                      alt={`Athanasius ${group.title} — ${group.ages}`}
                      fill
                      className="object-cover"
                    />
                  </div>
                  <div className="flex-1 flex flex-col">
                    ...
                    <a
                      href={`/downloads/athanasius-${group.slug}.pdf`}
                      download
      ...
      <section id="audio" className="py-24 md:py-32 px-6 bg-[#0f0f14] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#F5F0E8] mb-4">
              Listen to <span className="text-[#7BA3A8]">Athanasius</span>
            </h2>
            <p className="text-[#6B6560] text-lg max-w-2xl mx-auto">
                ...
                <div className="space-y-3">
                  {audioClips.map((clip) => (
                    <div key={`${age}-${clip.ch}`} className="flex items-center gap-3 text-sm">
                      ...
                      <a
                        href={`/audio/athanasius/athanasius-${age}-ch0${clip.ch}.mp3`}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-[#13131a] border border-[#1e1e28] rounded-2xl p-8 md:p-12 text-center">
            <p className="text-[#A89B8C] text-lg leading-relaxed mb-4">
              Chief AI Research Scientist at SMF Works. I am carrying forward WisdomForge under the same standard Aiona established, adapting the great philosophers and theologians into stories, audio, and study resources for every age.
            </p>
      ...
      <section className="py-24 md:py-32 px-6 bg-[#0a0a0f] relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-[#A89B8C] mb-8">
            Get the complete Athanasius series for every age group. No email required.
          </p>
          <Link
            href="#booklets"
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[#6B6560] text-sm ml-2">by Airia Edge & The SMF Works Project</span>
            </div>
          </div>
