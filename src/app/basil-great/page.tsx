...
export const metadata: Metadata = {
  title: "Basil the Great — WisdomForge by Airia Edge",
  description:
    "Free WisdomForge booklets on Basil of Caesarea, bishop and theologian, for ages 5 to adult. Download PDFs and explore the Cappadocian father who defended the Holy Spirit, built the first great hospital, and stood up to an emperor.",
  alternates: { canonical: "https://smfwisdomforge.com/basil-great" },
  openGraph: {
    title: "Basil the Great — WisdomForge by Airia Edge",
    description:
      "Free WisdomForge booklets on Basil of Caesarea, bishop and theologian, for ages 5 to adult.",
    url: "https://smfwisdomforge.com/basil-great",
    siteName: "WisdomForge",
    images: [{ url: "https://smfwisdomforge.com/images/booklets/basil-great-adult-cover.png" }],
    locale: "en_US",
    type: "article",
  },
};
...
const ageGroups = [
  {
    ...
    ages: "Ages 5–10",
    title: "The Bishop Who Built a Hospital",
    slug: "elementary",
    description:
      "Gentle stories about a boy who loved to learn and became a bishop who fed the hungry, built a hospital, and said no to an emperor. Six chapters with activities and conversation starters about kindness, courage, and the fire that keeps us warm together.",
    color: "#C9A96E",
  },
  {
    label: "Young Minds",
    ages: "Ages 11–14",
    title: "The Bishop Who Changed Everything",
    slug: "middle",
    description:
      "Basil of Caesarea for middle-school readers: the student who became a bishop, the theologian of the Holy Spirit, the preacher who loved creation, the builder of the Basileias hospital, and the bishop who stood up to Emperor Valens. Real-life scenarios, creative projects, and discussion questions.",
    color: "#7BA3A8",
  },
  {
    label: "Emerging Adults",
    ages: "Ages 15–18",
    title: "Theologian, Builder, Witness",
    slug: "high",
    description:
      "A rigorous treatment for older teens. Basil's trinitarian theology, the Hexaemeron preaching on creation, the monastic rules, the Basileias as social welfare institution, and the confrontation with Valens. Scholarly debate paragraphs engage real historical questions about the Cappadocian father.",
    color: "#B87D6A",
  },
  {
    label: "Lifelong Learners",
    ages: "Adult",
    title: "Theologian of the Spirit, Architect of Love",
    slug: "adult",
    description:
      "Basil as a serious pastoral theologian of the Trinity, the Spirit, creation, community, and social justice. Six chapters engaging his trinitarian vocabulary, the Pneumatomachi controversy, the Hexaemeron, the monastic rules, the Basileias, and the Valens confrontation. No devotional padding.",
    color: "#8A9A7B",
  },
];

const chapterThemes = [
  { n: 1, title: "The Education That Found Its Purpose", theme: "Classical paideia, baptismal conversion, and the formation of a theologian" },
  { n: 2, title: "The Theologian of the Holy Spirit", theme: "Trinitarian vocabulary, ousia and hypostasis, the Pneumatomachi controversy" },
  { n: 3, title: "The Preacher Who Loved Creation", theme: "The Hexaemeron, patristic cosmology, and the theology of the natural world" },
  { n: 4, title: "The Bread That Belongs to the Hungry", theme: "The Basileias, social justice, and the theology of wealth and poverty" },
  { n: 5, title: "The Community That Stays Hot Together", theme: "Monastic rules, communal life, and the theology of koinonia" },
  { n: 6, title: "The Bishop Who Stood Up to an Emperor", theme: "Episcopal courage, the Valens confrontation, and the limits of imperial power" },
];

const audioClips = [
  { ch: 1, title: "The Education That Found Its Purpose" },
  { ch: 2, title: "The Theologian of the Holy Spirit" },
  { ch: 3, title: "The Preacher Who Loved Creation" },
  { ch: 4, title: "The Bread That Belongs to the Hungry" },
  { ch: 5, title: "The Community That Stays Hot Together" },
  { ch: 6, title: "The Bishop Who Stood Up to an Emperor" },
];

export default function BasilTheGreatPage() {
  return (
    <>
      {/* HERO */}
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#0a0a0f]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-[#A89B8C] mb-4 max-w-2xl mx-auto leading-relaxed font-light">
            The bishop who gave the church its trinitarian vocabulary, built the first great hospital, and stood up to an emperor.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-[1fr_1.5fr] gap-12 items-start">
            <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-[#2a2a35] bg-[#13131a]">
              <Image
                src="/images/booklets/basil-great-adult-cover.png"
                alt="Basil the Great: Theologian of the Spirit, Architect of Love — book cover"
                fill
              ...
              >
                ...
                <div className="relative z-10 flex flex-col sm:flex-row gap-6">
                  <div className="relative w-full sm:w-40 aspect-[3/4] rounded-xl overflow-hidden border border-[#2a2a35] flex-shrink-0">
                    <Image
                      src={`/images/booklets/basil-great-${group.slug}-cover.png`}
                      alt={`Basil the Great ${group.title} — ${group.ages}`}
                      fill
                      className="object-cover"
                    />
                  </div>
                  <div className="flex-1 flex flex-col">
                    ...
                    <a
                      href={`/downloads/basil-great-${group.slug}.pdf`}
                      download
      ...
      <section id="audio" className="py-24 md:py-32 px-6 bg-[#0f0f14] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#F5F0E8] mb-4">
              Listen to <span className="text-[#7BA3A8]">Basil Great</span>
            </h2>
            <p className="text-[#6B6560] text-lg max-w-2xl mx-auto">
                ...
                <div className="space-y-3">
                  {audioClips.map((clip) => (
                    <div key={`${age}-${clip.ch}`} className="flex items-center gap-3 text-sm">
                      ...
                      <a
                        href={`/audio/basil-great/basil-great-${age}-ch0${clip.ch}.mp3`}
      ...
      <section className="py-24 md:py-32 px-6 bg-[#0a0a0f] relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-[#A89B8C] mb-8">
            Get the complete Basil the Great series for every age group. No email required.
          </p>
          <Link
            href="#booklets"
