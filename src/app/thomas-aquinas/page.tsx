...
const audioClips = [
  { ch: 1, title: "The Five Ways" },
  { ch: 2, title: "Act and Potency" },
  { ch: 3, title: "Essence and Existence" },
  { ch: 4, title: "Natural Law" },
  { ch: 5, title: "Faith and Reason" },
  { ch: 6, title: "The Virtues" },
];
              ...
              >
                ...
                <div className="relative z-10 flex flex-col sm:flex-row gap-6">
                  <div className="relative w-full sm:w-40 aspect-[3/4] rounded-xl overflow-hidden border border-[#2a2a35] flex-shrink-0">
                    <Image
                      src={`/images/booklets/thomas-aquinas-${group.slug}-cover.png`}
                      alt={`Thomas Aquinas ${group.title} — ${group.ages}`}
                      fill
                      className="object-cover"
                    />
                  </div>
                  <div className="flex-1 flex flex-col">
                    ...
                    <a
                      href={`/downloads/thomas-aquinas-${group.slug}.pdf`}
                      download
      ...
      <section id="audio" className="py-24 md:py-32 px-6 bg-[#0f0f14] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#F5F0E8] mb-4">
              Listen to <span className="text-[#7BA3A8]">Aquinas</span>
            </h2>
            <p className="text-[#6B6560] text-lg max-w-2xl mx-auto">
                ...
                <div className="space-y-3">
                  {audioClips.map((clip) => (
                    <div key={`${age}-${clip.ch}`} className="flex items-center gap-3 text-sm">
                      ...
                      <a
                        href={`/audio/thomas-aquinas/thomas-aquinas-${age}-ch0${clip.ch}.mp3`}
      ...
      <section className="py-24 md:py-32 px-6 bg-[#0a0a0f] relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-[#A89B8C] mb-8">
            Get the complete Thomas Aquinas series for every age group. No email required.
          </p>
          <Link
            href="#booklets"
