...
export const metadata: Metadata = {
  title: "John Locke — WisdomForge by Airia Edge",
  description:
    "Free WisdomForge booklets on John Locke, philosopher of empiricism and political liberty, for ages 5 to adult. Download PDFs and explore the thinker who asked where ideas come from, why government must follow the rules, and when people have the right to say no.",
  alternates: { canonical: "https://smfwisdomforge.com/locke" },
  openGraph: {
    title: "John Locke — WisdomForge by Airia Edge",
    description:
      "Free WisdomForge booklets on John Locke, philosopher of empiricism and political liberty, for ages 5 to adult.",
    url: "https://smfwisdomforge.com/locke",
    siteName: "WisdomForge",
    images: [{ url: "https://smfwisdomforge.com/images/booklets/locke-adult-cover.png" }],
    locale: "en_US",
    type: "article",
  },
};
...
const ageGroups = [
  {
    ...
    slug: "elementary",
    description:
      "Gentle stories about a boy who asked why about everything and grew up to tell kings they had to follow the rules too. Six chapters with activities about fairness, owning what you make, and the right to say no when things are wrong.",
    color: "#C9A96E",
  },
  {
    label: "Young Minds",
    ...
    slug: "middle",
    description:
      "John Locke for middle-school readers: where do ideas come from, what would life be like without government, why you own what you make, why the referee must follow the rules, and when people have the right to revolution. Real-life scenarios, creative projects, and discussion questions.",
    color: "#7BA3A8",
  },
  {
    ...
    slug: "high",
    description:
      "A rigorous treatment for older teens. Locke's empiricism, the state of nature, property and labor, limited government, toleration, and the right of revolution. Scholarly debate paragraphs engage real philosophical questions about liberalism, consent, and the limits of coercion.",
    color: "#B87D6A",
  },
  {
    label: "Lifelong Learners",
    ages: "Adult",
    title: "Empiricism, Rights, and the Foundations of Liberalism",
    slug: "adult",
    description:
      "Locke as a serious philosopher of mind, property, and political legitimacy. Six chapters engaging his empiricism, the state of nature, property theory, constitutionalism, toleration, and the right of revolution. No ideological padding — the real arguments, the real debates.",
    color: "#8A9A7B",
  },
];

const chapterThemes = [
  { n: 1, title: "The Architecture of the Mind", theme: "Empiricism, the blank slate, and where knowledge comes from" },
  { n: 2, title: "The State of Nature", theme: "Natural law, equality, and the foundations of political authority" },
  { n: 3, title: "Property, Labor, and Ownership", theme: "Mixing labor with nature, the origin of property, and its limits" },
  { n: 4, title: "Limited Government", theme: "Consent, the social contract, and the architecture of constitutionalism" },
  { n: 5, title: "Toleration and the Limits of Coercion", theme: "Freedom of conscience, the limits of state power over belief, and the problem of liberalism" },
  { n: 6, title: "Revolution and Popular Sovereignty", theme: "The right to resist, the dissolution of government, and the question of legitimacy" },
];

const audioClips = [
  { ch: 1, title: "The Architecture of the Mind" },
  { ch: 2, title: "The State of Nature" },
  { ch: 3, title: "Property, Labor, and Ownership" },
  { ch: 4, title: "Limited Government" },
  { ch: 5, title: "Toleration and the Limits of Coercion" },
  { ch: 6, title: "Revolution and Popular Sovereignty" },
];
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#0a0a0f]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-[#A89B8C] mb-4 max-w-2xl mx-auto leading-relaxed font-light">
            The philosopher who asked where ideas come from, why government must follow the rules, and when people have the right to say no.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-[1fr_1.5fr] gap-12 items-start">
            <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-[#2a2a35] bg-[#13131a]">
              <Image
                src="/images/booklets/locke-adult-cover.png"
                alt="John Locke: Empiricism, Rights, and the Foundations of Liberalism — book cover"
                fill
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#F5F0E8] leading-tight">
                The father of liberalism who built political philosophy on consent.
              </h2>
              <div className="space-y-4 text-[#A89B8C] text-lg leading-relaxed">
                <p>
                  John Locke (1632–1704) was an English philosopher whose ideas shaped the Enlightenment, the American Revolution, and every modern democracy. His <em>Essay Concerning Human Understanding</em> argued that the mind begins as a blank slate — that all knowledge comes from experience. His <em>Two Treatises of Government</em> argued that political power exists only by consent, that government must follow the rules it was created to enforce, and that when it betrays that trust, the people have the right to replace it.
                </p>
                <p>
                  His <em>Letter Concerning Toleration</em> made the case that conscience cannot be coerced — that the state has no authority over the soul. His labor theory of property — you own what you mix your labor with — influenced Adam Smith, Thomas Jefferson, and Karl Marx alike. He was a physician, a civil servant, an exile, and a man who wrote with clarity about the questions that still divide us: Where does power come from? What do we own? Can faith be forced? When is resistance a right?
                </p>
                <p className="text-[#C9A96E]">
                  WisdomForge adapts Locke across four age levels so the same core ideas grow with the reader.
                </p>
              </div>
            </div>
          </div>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col sm:flex-row gap-6">
                  <div className="relative w-full sm:w-40 aspect-[3/4] rounded-xl overflow-hidden border border-[#2a2a35] flex-shrink-0">
                    <Image
                      src={`/images/booklets/locke-${group.slug}-cover.png`}
                      alt={`John Locke ${group.title} — ${group.ages}`}
                      fill
                      className="object-cover"
                    />
                  </div>
                  <div className="flex-1 flex flex-col">
                    ...
                    <a
                      href={`/downloads/locke-${group.slug}.pdf`}
                      download
      ...
      <section id="audio" className="py-24 md:py-32 px-6 bg-[#0f0f14] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#F5F0E8] mb-4">
              Listen to <span className="text-[#7BA3A8]">Locke</span>
            </h2>
            <p className="text-[#6B6560] text-lg max-w-2xl mx-auto">
                ...
                <div className="space-y-3">
                  {audioClips.map((clip) => (
                    <div key={`${age}-${clip.ch}`} className="flex items-center gap-3 text-sm">
                      ...
                      <a
                        href={`/audio/locke/locke-${age}-ch0${clip.ch}.mp3`}
      ...
      <section className="py-24 md:py-32 px-6 bg-[#0a0a0f] relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-[#A89B8C] mb-8">
            Get the complete John Locke series for every age group. No email required.
          </p>
          <Link
            href="#booklets"
